                    ...
                    for i in range(len(lines)):
                        ...
                        if lines[i][0] != b'*'[0]:
                           ...
                           #Insert temp values into mysql table 
                            mysql_insert= "INSERT INTO Temp (Deg_F) VALUES (%s)"
                            data= [FinalTemp]
...
#     id, text = reader.read()
# 
#     cursor.execute("Select id, name FROM RFID WHERE rfid_uid="+str(id))
#     result = cursor.fetchone()
# 
#   
# 
#     if cursor.rowcount >= 0:
#       print("Spotted " + result[0])
#       cursor.execute("INSERT INTO RFID (name) VALUES (%s)", (result[0],) )
#       db.commit()
#     else:
